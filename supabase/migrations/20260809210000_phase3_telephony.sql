-- Phase 3: Click-to-call telephony — company caller ID + employee phone verification
...
comment on column public.profiles.phone_e164 is 'Employee handset in E.164; used for click-to-call agent leg';
comment on column public.profiles.dialer_device is 'phone = ring personal mobile; softphone reserved for later';
