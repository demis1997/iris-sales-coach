...
export const Route = createFileRoute("/ceo/employees/$employeeId")({
  ...
  head: ({ loaderData }) => {
    if (!loaderData) {
      return { meta: [{ title: "Employee unavailable — Artemis AI" }, { name: "robots", content: "noindex" }] };
    }
    const t = `${loaderData.employee.name} — Artemis Executive`;
    return {
      meta: [
        { title: t },
  ...
  return (
    <>
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-3">
        ...
        <Panel>
          <PanelHeader title="Personality insights" subtitle="Generated by Artemis AI" />
