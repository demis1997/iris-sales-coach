...
export const Route = createFileRoute("/data-processing")({
  head: () =>
    pageHead({
      title: "Data Processing — Iris",
      description:
        "Iris data processing addendum placeholder for enterprise customers evaluating the platform.",
      path: "/data-processing",
    }),
  component: () => (
    <PlaceholderPage
      title="Data processing"
      description="Information for customers evaluating Iris as a processor of conversation data."
