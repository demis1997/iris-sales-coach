...
export const Route = createFileRoute("/about")({
  head: () =>
    pageHead({
      title: "About — Iris",
      description:
        "Iris is building the AI operating system for high-performance sales teams—coaching, pipeline intelligence, and organisational learning from every conversation.",
      path: "/about",
    }),
  component: () => (
    <PlaceholderPage
