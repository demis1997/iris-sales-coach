...
export const Route = createFileRoute("/terms")({
  head: () =>
    pageHead({
      title: "Terms of Service — Artemis",
      description: "Artemis terms of service placeholder for the evaluation website.",
      path: "/terms",
    }),
  component: () => (
    <PlaceholderPage
      title="Terms of service"
      description="Terms governing use of the Artemis website and product."
