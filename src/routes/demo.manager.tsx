...
const nav: DemoNavItem[] = [
  ...
  { label: "Agents", to: "/demo/manager/team", icon: Users, section: "Floor" },
  { label: "Campaigns", to: "/demo/manager/campaigns", icon: Target, section: "Floor" },
  { label: "Calls", to: "/demo/manager/calls", icon: PhoneCall, section: "Quality" },
  { label: "Coaching", to: "/demo/manager/coaching", icon: Sparkles, section: "Quality" },
  { label: "QA", to: "/demo/manager/calls", icon: PhoneCall, section: "Quality" },
  { label: "Playbooks", to: "/demo/manager/coaching", icon: Target, section: "Quality" },
  { label: "Analytics", to: "/demo/manager", icon: LayoutDashboard, section: "Quality" },
];

function ManagerDemoLayout() {
  return <DemoShell role="manager" workspace="Manager OS" nav={nav} />;
}
