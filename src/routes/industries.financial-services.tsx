...
export const Route = createFileRoute("/industries/financial-services")({
  head: () =>
    pageHead({
      title: "Artemis for Financial Services",
      description:
...
function Page() {
  return (
    <MarketingPage
      ...
      lede="Artemis helps wealth, banking, and financial product teams coach discovery quality, surface pipeline risk, and keep CRM records complete—without claiming to replace compliance programmes."
    >
      <Section>
        <FeatureList
          items={[
