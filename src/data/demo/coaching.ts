...
export const DEMO_COACHING: CoachingAssignment[] = [
  ...
  },
  {
    ...
    weakness: "Compliance",
    evidence: "1 critical phrase missed on promotions language",
    recommendation: "Re-certify promotions compliance before CFD outbound unlock.",
    assignment: "Promotions compliance micro-cert",
    due: "Today",
    status: "open",
  },
  {
...
export const LIVE_FLOOR: LiveFloorAgent[] = [
  ...
  { agentId: "agt-leo", name: "Leo", status: "wrap", signal: null },
  { agentId: "agt-george", name: "George", status: "available", signal: null },
  {
    agentId: "agt-sofia",
    name: "Sofia",
    status: "live",
  ...
  { agentId: "agt-anna", name: "Anna", status: "available", signal: null },
  { agentId: "agt-chris", name: "Chris", status: "break", signal: "compliance" },
];
