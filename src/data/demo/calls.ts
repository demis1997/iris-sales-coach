...
export const DEMO_CALLS: DemoCall[] = [
  ...
  },
  {
    ...
    analysis: {
      ...
      summary: "Simulated AI demo — live coaching suggestions. Same call as Agent Sales Workspace.",
    },
    transcript: [
      {
        id: "l1",
        ...
        speaker: "agent",
        name: "Maria G.",
        text: "Before we go further, what made you register with us today?",
        highlight: "good",
      },
      {
        id: "l2",
        ...
        speaker: "prospect",
        name: "Client 10821",
        text: "I've been looking at trading for a while. I just haven't really trusted any of these platforms.",
      },
      {
        id: "l3",
        at: "08:05",
        speaker: "agent",
        name: "Maria G.",
        text: "That's completely understandable. Have you traded before?",
        highlight: "good",
      },
      {
        id: "l4",
        ...
        speaker: "prospect",
        name: "Client 10821",
        text: "A little bit. My biggest concern is getting my money back out.",
        highlight: "objection",
      },
    ],
  },
